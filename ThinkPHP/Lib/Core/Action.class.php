...
abstract class Action {
   ...
   /**
    ...
    static function dump($data,$M=null,$print=true)
    {

        $msg= "<pre class='alert-success'>打印清单".print_r($data,true)."<br/></pre>";

        if($M){
            $msg.= "<pre class='alert-error'>SQL:  ".$M->getLastSql().'<br/><hr/>';
            $msg.= "错误信息:  ".$M->getDbError().'</pre>';
